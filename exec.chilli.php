...
if($argv[1]=="--start-dnsmasq"){$GLOBALS["OUTPUT"]=true;$GLOBALS["DNMASQCONF"]=true;start_dnsmasq();die();}
if($argv[1]=="--build"){$GLOBALS["OUTPUT"]=true;$GLOBALS["RELOAD"]=true;build();die();}
if($argv[1]=="--web"){$GLOBALS["OUTPUT"]=false;coova_web();die();}
if($argv[1]=="--init"){$GLOBALS["OUTPUT"]=false;chilli_init_d();die();}
if($argv[1]=="--status"){$GLOBALS["OUTPUT"]=false;;die();}
