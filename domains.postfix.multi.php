...
function popup(){
	...
	$html="$title<div style='width:100%'>
	<table style='width:100%;margin-left:-10px;margin:right:-10px'>
	<tr>	
	<td valign='top' width=5% >
		<div id='postfix-multi-servers-list'></div>
		<div id='postfix-multi-servers-listed'></div>	
	</td>
	<td valign='top' width=95% style='padding-right:5px'><div id='postfix-multi-servers-content' style='width:100%'></div></td>
	</tr>
	</table>
	</div>
