...
function popup(){
	...
	if($EnableAmavisDaemon==0){
		$EnableAmavisDaemonP=Paragraphe32("disabled", "amavis_is_currently_disabled_text", "EnablePopupAmavis()", "warning32.png");
	}else{
	...
	<tr>
		...
		<td valign='top'>
			<div style='font-size:18px;margin:bottom:10px;text-align:right'>{APP_AMAVIS}</div>
			<div style='font-size:14px' class=explain>{AMAVIS_DEF}</div>
