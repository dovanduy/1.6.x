...
function security_postfix(){
	...
	$PostfixEnableSubmission_js="Loadjs('postfix.index.php?script=auth');";
	if($PostFixSmtpSaslEnable<>1){$PostFixSmtpSaslEnable='{disabled}';}else{$PostFixSmtpSaslEnable="{enabled}";}
	if($TrustMyNetwork<>1){$TrustMyNetwork='{disabled}';}else{$TrustMyNetwork="{enabled}";}
	...
	<table style='width:98%' class=form>
		...
		<tr>
			<td class=legend width='350px'>{sasl_title}:</td>
			<td width='230px'><a href=\"javascript:blur()\" OnClick=\"javascript:$PostfixEnableSubmission_js\" $stylea>$PostFixSmtpSaslEnable</a></td>
			<td width=1% nowrap><strong style='font-size:13px'>&nbsp;</td>
		</tr>	
		<tr>
			<td class=legend width='350px'>{TrustMyNetwork}:</td>
			<td width='230px'><a href=\"javascript:blur()\" OnClick=\"javascript:$PostfixEnableSubmission_js\" $stylea>$TrustMyNetwork</a></td>
			<td width=1% nowrap><strong style='font-size:13px'>{reject}</td>
		</tr>
