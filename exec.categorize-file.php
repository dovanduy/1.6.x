...
if($argv[1]=="--crypted"){crypted();die();}
if($argv[1]=="--import-translated"){import_translated();die();}
if($argv[1]=="--export-dynamic"){export_dynamic();die();}
if($argv[1]=="--parse"){parse_txt($argv[2]);die();}
