...
$f[]="configtest() {";
$f[]="	# Start message";
$f[]="	message \"info\" \"[INFO] Launching OpenLDAP configuration test...\"";
...
$f[]="	if [ \"\$SLAPD_CONF_DIR\" ]";
$f[]="	then";
$f[]="		SLAPTEST_PARAMS=\"\$SLAPTEST_PARAMS -F \$SLAPD_CONF_DIR\"";
$f[]="	elif [ \"\$SLAPD_CONF\" ]";
$f[]="	then";
$f[]="		SLAPTEST_PARAMS=\"\$SLAPTEST_PARAMS -f \$SLAPD_CONF\"";
$f[]="	fi";
$f[]="";
$f[]="	# slaptest";
$f[]="	if [ -z \"\$SU\" ]";
$f[]="	then";
$f[]="		\$SLAPTEST_BIN \$SLAPTEST_PARAMS > /dev/null 2>&1";
$f[]="	else";
$f[]="		\$SU \"\$SLAPTEST_BIN \$SLAPTEST_PARAMS > /dev/null 2>&1\"";
$f[]="	fi";
$f[]="";
$f[]="	if [ \$? -eq 0 ]";
$f[]="	then";
$f[]="		message \"info\" \"[OK] OpenLDAP configuration test successful\"";
$f[]="	else";
$f[]="		message \"alert\" \"[ALERT] OpenLDAP configuration test failed\"";
$f[]="		exit 1";
$f[]="	fi";
$f[]="}";
$f[]="";
