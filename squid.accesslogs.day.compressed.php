...
function table(){
	...
	$title=$tpl->javascript_parse_text("{this_day}");
	$html="
	...
	dataType: 'json',
	colModel : [
	{display: '$hour', name : 'hour', width : 54, sortable : true, align: 'center'},
	{display: '$familysite', name : 'familysite', width : 299, sortable : true, align: 'left'},
	...
	{display: '$hits', name : 'hits', width : 92, sortable : true, align: 'right'},
	{display: '$size', name : 'size', width : 92, sortable : true, align: 'right'},
	],
