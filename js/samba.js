...
var x_RefreshUserList=function (obj) {
	if( document.getElementById('flexRT-users-list')){
		var id=document.getElementById('flexRT-users-list').value;
		$('#flexRT'+id).flexReload();
		return;
	}
...
function FindUserGroup(){
	...
	if( document.getElementById('finduserandgroupsid')){
		...
		if(document.getElementById('IsTimeCapsule')){IsTimeCapsule=document.getElementById('IsTimeCapsule').value;}
		XHR.appendData('finduserandgroup','yes');
		XHR.appendData('IsNFS',IsNFS);
		XHR.appendData('IsTimeCapsule',IsTimeCapsule);
		XHR.appendData('query',document.getElementById('query').value);
		AnimateDiv('finduserandgroupsid');    
