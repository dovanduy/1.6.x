<?php
	...
	if(isset($_POST["share_delete"])){folder_delete();exit;}
...
function folder_params(){
	...
	<tr>
	<td colspan=2 align='right'><hr>". button($button,"SaveSMBFolder()",16)."</td></tr>
	</table>
...
function folder_save(){
	$samba=new samba_virtuals_folders($_POST["folder-id"]);
