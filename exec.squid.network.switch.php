...
function build_progress($text,$pourc){
	...
	$array["TEXT"]=$text;
	echo "[$pourc]: $text\n";
	@file_put_contents("/usr/share/artica-postfix/ressources/logs/web/squid.network.switch.progress", serialize($array));
	@chmod("/usr/share/artica-postfix/ressources/logs/web/squid.network.switch.progress",0755);
	sleep(1);
