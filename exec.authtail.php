...
function start($aspid=false){
	...
	if(!is_file($authlog)){
		if($GLOBALS["OUTPUT"]){echo "Starting......: [INIT]: {$GLOBALS["TITLENAME"]} unable to stat auth.log!!!\n";}
		return;
	}
	STOP_TAIL_INSTANCES();
	
	if($GLOBALS["OUTPUT"]){echo "Starting......: [INIT]: {$GLOBALS["TITLENAME"]} file events: $authlog\n";}
