...
<div style='width:98%' class=form>
	...
	<tbody>
	<tr>
		<td align='right' width=1% nowrap style='font-size:22px' class=legend>{enabled}:</strong></td>
		<td>". Field_checkbox_design("enabled-$t", 1,$ligne["enabled"])."</td>
	</tr>		
	<tr>
		<td align='right' width=1% nowrap style='font-size:22px' class=legend>{action}:</strong></td>
		<td><strong>$arrayf</strong></td>
	</tr>	
	<tr>
		<td align='right' width=1% nowrap style='font-size:22px' class=legend>{analyze}:</strong></td>
		<td><strong>$arrayd</strong></td>
	</tr>

	<tr>
	<tr>
		<td swidth=1% nowrap style='font-size:22px;vertical-align:top' class=legend>{regex}:</strong></td>
		<td>$PatternField</td>
	</tr>
	<tr>
		<td align='right' width=1% nowrap style='font-size:22px' class=legend>{reverse}:</strong></td>
		<td>". Field_checkbox_design("reverse-$t", 1,$ligne["reverse"])."</td>
	</tr>	
	<tr>
		<td align='right' width=1% nowrap style='font-size:22px' class=legend>{extended_regex}:</strong></td>
