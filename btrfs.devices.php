...
function popup_list(){
	...
	while (list ($index, $array) = each ($MAIN) ){	
		...
		$hrefdevices="<a href=\"javascript:blur()\" OnClick=\"javascript:Loadjs('$MyPage?show-devices-js=$uuid');\" style='font-size:18px;text-decoration:underline;font-weight:bold'>";
