...
function details_tablerows(){
	...
	while ($ligne = mysql_fetch_assoc($results)) {
		...
		$ahrefFrom="<a href=\"javascript:blur();\"
		OnClick=\"javascript:Loadjs('$MyPage?details-js=yes&field=IP_FROM&value=$ipfrom&host=$ipfrom_host')\"
		style='font-size:13px;text-decoration:underline'>";
		
		$ahrefto="<a href=\"javascript:blur();\" 
		OnClick=\"javascript:Loadjs('$MyPage?details-js=yes&field=IP_TO&value=$ipto&host=$ipto_host')\"
		style='font-size:13px;text-decoration:underline'>";		
