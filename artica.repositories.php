...
function tabs(){
	...
	if($packagesNumber>0){
		$array["config-update_now"]='{packages_list}';
	}	
	...
	while (list ($num, $ligne) = each ($array) ){
		...
		if($num=="config-update_now"){
			$html[]= $tpl->_ENGINE_parse_body("<li><a href=\"artica.update.php?main_artica_update=apt\"><span>$ligne</span></a></li>\n");
			continue;
		}
