...
RRDs::graph("$img_path/connections.month.png",
...
RRDs::graph("$img_path/connections.week.png",
	'--title',"Connections -- Week",
        '--start', '-1week',
        '--imgformat', 'PNG',
        '--vertical-label',"req/sec",
        '--width','650',
...
RRDs::graph("$img_path/connections.hour.png",
	...
	'--font','DEFAULT:8',
      	'--lower-limit', '0',
	'--x-grid',"MINUTE:5:MINUTE:5:MINUTE:5:0:%M",
        '--imgformat', 'PNG',
        '--vertical-label',"req/sec",
        '--width','600',
	'--height','200',
...
RRDs::graph("$img_path/cpu.hour.png",
	'--title',"CPU Usage -- this hour",
        '--start', "$start_time",
	'--end',"$end_time",
        '--imgformat', 'PNG',
...
RRDs::graph("$img_path/cpu.week.png",
	'--title',"CPU Usage -- this month",
        '--start','-1month',
        '--imgformat', 'PNG',
        '--vertical-label',"Percent",
        '--width','650',
...
RRDs::graph("$img_path/cpu.month.png",
	'--title',"CPU Usage -- this Week",
        '--start','-1week',
        '--imgformat', 'PNG',
        '--vertical-label',"Percent",
        '--width','650',
...
RRDs::graph("$img_path/memory.week.png",
	'--title',"Memory -- Week",
        '--start','-1week',
        '--imgformat','PNG',
        '--vertical-label', "Megabytes",
...
RRDs::graph("$img_path/memory.month.png",
	'--title',"Memory -- Month",
        '--start','-1month',
        '--imgformat','PNG',
        '--vertical-label', "Megabytes",
