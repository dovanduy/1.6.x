...
install.INSTALL_STATUS('APP_MILTERGREYLIST',10);
  ...
  fpsystem('cd ' + source_folder + ' && ./configure --with-user=postfix --enable-postfix --with-libGeoIP --enable-mx --enable-dnsrbl CFLAGS="-L/usr/lib/libmilter -L/lib -L/usr/lib -L/usr/local/lib"  && make && make install');
