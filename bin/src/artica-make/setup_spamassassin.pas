...
begin
   ...
   spamassassinbin:=SYS.LOCATE_GENERIC_BIN('spamassassin');
    writeln('Spamassassin binary =',spamassassinbin);
   if FileExists(spamassassinbin) then begin
