...
begin
     base:=trim(base);
      if length(base)>0 then begin
             writeln('Welcome on the Artica installation process 1.3');
             writeln('');
...
if length(trim(base))=0 then begin
    ...
    if length(Samba)>0 then begin
     ...
     writeln('Files Sharing (include Samba and Pure-ftpd):..........: Disabled: require: "',base,'" (stop the install program and restart it)');
end;
...
if length(trim(base))=0 then begin
   if kvmready then begin
      if length(kvmpackages)>0 then begin
         plistSquid:=explode(',', kvmpackages);
         writeln('Virtualization System :...............................:[K] ('+IntToStr(length(plistSquid)-1)+' package(s))');
      end else begin
           writeln('Virtualization System :...............................:Installed');
      end;
   end else begin
        writeln('Virtualization System :...............................: Hardware not compliance');
   end;
end;
