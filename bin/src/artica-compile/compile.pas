...
RegExpr:TRegExpr;
i:integer;
   dir,newdir,cmd,targetfile,MAIN_RELEASE,FULL_PATCH_PATH,FULL_PATCH_PATH_NEW_DIR,FULL_PATCH_PATH_ROOT,MAIN_RELEASE_NAME:string;
   ll:TstringList;
   patchname:string;
   dirorg:string;
begin
...
logs:=Tlogs.Create;
    ...
    MAIN_RELEASE_NAME:=MAIN_RELEASE+'_'+ patchname;
    ...
    if FileExists(FULL_PATCH_PATH_ROOT+'/'+MAIN_RELEASE_NAME+'.tar.gz') then fpsystem('/bin/rm -f '+FULL_PATCH_PATH_ROOT+'/'+MAIN_RELEASE_NAME+'.tar.gz');
    writeln('compressing '+FULL_PATCH_PATH_ROOT+'/'+MAIN_RELEASE_NAME+'.tar.gz FROM  '+FULL_PATCH_PATH_ROOT);
    fpsystem('/bin/tar -czf '+FULL_PATCH_PATH_ROOT+'/'+MAIN_RELEASE_NAME+'.tar.gz *');
