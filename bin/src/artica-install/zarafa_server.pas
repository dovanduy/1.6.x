...
l.add('server_tcp_port		= '+IntToStr(ZarafaServerListenPort));
...
l.add('server_ssl_port		= '+IntToStr(ZarafaMAPISSLPort));
...
if ZarafaAlwaysSendDelegates=0 then l.add('always_send_delegates = no');
...
if ZarafaServerListenIP ='0.0.0.0' then begin
   l.add('server_socket	=	http://localhost:'+IntToStr(ZarafaServerListenPort)+'/zarafa');
end else begin
   l.add('server_socket	=	http://'+ZarafaServerListenIP+':'+IntToStr(ZarafaServerListenPort)+'/zarafa');
end;
...
var
  ...
  ZarafaServerListenPort:integer;
