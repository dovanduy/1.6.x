...
openemm,yaffas,memcached,ejabberd,
...
begin
    ...
    try ldap:=topenldap.Create; ldap.LDAP_START(); finally end;
     ...
     writeln('Starting......: Starting cron scheduler...');
...
INSTANT_SEARCH();
   ...
   if FileExists(SYS.LOCATE_LSHW()) then begin
      ...
      if not FileExists('/usr/share/artica-postfix/ressources/logs/LSHW.PROC.HTML') then LSHW_TIME:=7000;
      if LSHW_TIME>6000 then begin
       ...
       logs.WriteToFile('Unable to stat LSHW tool...','/usr/share/artica-postfix/ressources/logs/LSHW.ERROR.TXT');
       fpsystem('chmod 777 /usr/share/artica-postfix/ressources/logs/LSHW.ERROR.TXT');
