...
$GLOBALS["MYSQL_SOCKET"]="/var/run/articadb.sock";
$GLOBALS["MYPID"]="/etc/artica-postfix/pids/{$GLOBALS["SERV_NAME"]}.pid";
$GLOBALS["MYSQL_BIN_PATH"]="/opt/articatech/bin/articadb";
...
function initd(){
	...
	echo "Starting......: [INIT]:{$GLOBALS["SERV_NAME"]} /etc/init.d/{$GLOBALS["SERV_NAME"]} done..\n";
