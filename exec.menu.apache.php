...
function restart(){
	...
	system("/etc/init.d/artica-process1 start --force");
	system("/etc/init.d/artica-webconsole restart --force");
	system("/etc/init.d/artica-framework restart --force");
...
$diag[]="--title \"[ W E B  I N T E R F A C E  M E N U ]\"";
...
$diag[]="RESTART \"Restart Web Console service\"";
$diag[]="ERRORS \"Display error events\"";
...
$f[]="function ERRORS(){";
$f[]="\t$DIALOG --textbox /var/log/lighttpd/apache-error.log  25 150";	
$f[]="}";
$f[]="";
...
$f[]="\t\trm /tmp/dns.log";
$f[]="\tfi";
$f[]="\t$php ".__FILE__." --restart >/tmp/dns.log &";
$f[]="\t$DIALOG --tailbox /tmp/dns.log  25 150";
$f[]="}";
$f[]="";
...
if($GLOBALS["VERBOSE"]){echo "Writing /tmp/bash_apache_menu.sh\n";}
@file_put_contents("/tmp/bash_apache_menu.sh", @implode("\n",$f));
@chmod("/tmp/bash_apache_menu.sh",0755);
