...
function build_current_time(){
	...
	$cacheFile="/usr/share/artica-postfix/ressources/logs/web/BWMRT_OUT.db";
	@file_put_contents($cacheFile, serialize(array($ydata,$xdata)));
	@chmod($cacheFile,0755);

	$cacheFile="/usr/share/artica-postfix/ressources/logs/web/BWMRT_IN.db";
