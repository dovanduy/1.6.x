...
function popup(){
	...
	dataType: 'json',
	colModel : [
	{display: '$service', name : 'service', width :367, sortable : true, align: 'left'},
	{display: '$server_port', name : 'server_port', width :634, sortable : false, align: 'left'},
	{display: '$client_port', name : 'client_port', width :350, sortable : false, align: 'left'},
	...
	sortorder: 'asc',
	usepager: true,
	title: '<span style=font-size:30px>$service</span>',
	useRp: true,
	rp: 15,
...
function search(){
	...
	while ($ligne = mysql_fetch_assoc($results)) {
		...
		$delete=imgsimple("delete-48.png",null,"Loadjs('$MyPage?delete-js=$service')");
