...
function section_mynic(){echo "<script>Loadjs('system.nic.config.php?js=yes&in-front-ajax=yes&newinterface=yes');QuickLinkShow('quicklinks-parameters');</script>";}
function section_openvpn(){echo "<script>Loadjs('index.openvpn.php?infront=yes');QuickLinkShow('quicklinks-APP_OPENVPN');</script>";}
function section_network_services(){echo "<script>Loadjs('system.index.php?newtab=network');QuickLinkShow('quicklinks-network_services');</script>";}
function section_dhcp(){echo "<script>Loadjs('index.gateway.php?index_dhcp=yes&in-front-ajax=yes&newinterface=yes');QuickLinkShow('quicklinks-APP_DHCP');</script>";}
function section_statistics(){echo "<script>Loadjs('statistics.vnstat.php?newinterface=yes');QuickLinkShow('quicklinks-statistics');</script>";}
function section_computers(){echo "<script>Loadjs('ocs.search.php?js-in-front=yes');QuickLinkShow('quicklinks-browse_computers');</script>";}
function section_ocs(){echo "<script>Loadjs('ocs.ng.php?in-front-ajax=yes&newinterface=yes');QuickLinkShow('quicklinks-APP_OCSI');</script>";}
