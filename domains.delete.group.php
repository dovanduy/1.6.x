...
function js(){
	...
	if($gp->groupName=="nogroup"){
		echo "alert('". $tpl->javascript_parse_text("{error_this_group_cannot_be_deleted}")."')";
		return;
	}
	...
	var x_ConfirmDeletionOfGroup= function (obj) {
		...
		if(document.getElementById('DomainsGroupFindPopupDiv')){DomainsGroupFindPopupDivRefresh();}
