...
if($argv[1]=='--checks-added'){ChecksAdded();die();}
if($argv[1]=='--checks-created'){ChecksCreated();die();}
if($argv[1]=='--checks-deletion'){ChecksDeleted();die();}
if($argv[1]=='--checks-single'){checksSingle($argv[2]);die();}
if($argv[1]=='--chpassword'){chpassword($argv[2]);die();}
