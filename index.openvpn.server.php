...
function js(){
	...
	$html="YahooWin4('630','$page?popup=yes','$title')";
	echo $html;
...
<tr>
	...
	<td>" . field_ipv4('IP_START',$vpn->main_array["GLOBAL"]["IP_START"],'font-size:14px;')."</td>
	<td>&nbsp;</td>
<tr>
<tr>
	<td class=legend style='font-size:14px'>{netmask}:</td>
	<td>" . field_ipv4('NETMASK',$vpn->main_array["GLOBAL"]["NETMASK"],'font-size:14px;')."</td>
	<td>&nbsp;</td>
</tr>
<tr>
...
<tr>
	...
	<td>" . field_ipv4('WAKEUP_IP',$vpn->main_array["GLOBAL"]["WAKEUP_IP"],'font-size:14px')."</td>
