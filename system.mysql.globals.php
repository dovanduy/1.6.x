...
$html="
	...
	<td>". Field_text("mysql-key-search{$_GET["instance-id"]}",null,"font-size:14px;padding:3px",null,null,null,false,"MysqlSearchCheck(event)")."</td>
	</tr>
	</table>
	</center>
	<div id='$t'></div>
	<script>
		...
		function MysqlsSearch(){
			var se=escape(document.getElementById('mysql-key-search{$_GET["instance-id"]}').value);
			LoadAjax('$t','$page?list-keys-search=yes&instance-id={$_GET["instance-id"]}&search='+se);
		}
